...
missing_coupling_genes <- setdiff(
  genes_coupling,
  rownames(spatial_all)
)

if (length(missing_coupling_genes) > 0) {
  
  stop(
    "Missing coupling genes: ",
    paste(
...
############################################################
## Build CDAA-HFD Kupffer-high source dataframe
############################################################
